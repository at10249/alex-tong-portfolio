      ...
      >
        ...
        <div style={{ padding: "18px 20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "9px" }}>
            <button onClick={() => setTheme("warm")} style={{ ...optionBase, border: `2px solid ${isTerminal ? "var(--border)" : "var(--accent)"}` }}>
            ...
            <button onClick={() => setTheme("terminal")} style={{ ...optionBase, border: `2px solid ${isTerminal ? "var(--accent)" : "var(--border)"}` }}>
              <span
                style={{
                  width: 34,
                  height: 34,
