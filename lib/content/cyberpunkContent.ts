...
export const cyberpunkContent: ThemeContent = {
  ...
  uiCopy: {
    ...
    sidebarCollapseTitle: "Stash comms",
    sidebarCollapseAria: "Stash the comms panel",
    sidebarExpandTitle: "Comms",
    sidebarExpandAria: "Pull up comms",
    ...
    chatHeaderHomeTitle: "Home Node",
    chatHeaderHomeAria: "Jack back to home node",
    ...
    shuffleThemeLabel: "Reroll persona",
    ...
    rightPaneCollapseTitle: "Stash shards",
    rightPaneCollapseAria: "Stash the data shards panel",
    rightPaneExpandTitle: "Data Shards",
    rightPaneExpandAria: "Pull up data shards",
