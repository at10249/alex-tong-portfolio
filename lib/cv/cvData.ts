// Plain structured facts for the generated CV PDF — reformatted for a
// resume rather than a chat answer, but drawn from exactly the same facts
...
export const cvEducationDetail = [
  {
    school: "University of Bonn",
    detail: "M.Sc., Agricultural and Food Economics (Market & Consumer Research) — Germany's #1-ranked university for Economics.",
  },
  {
    school: "UC Berkeley",
    detail: "2× B.S. — Environmental Economics & Policy; Society & Environment — graduated with Dean's Honors.",
  },
];
